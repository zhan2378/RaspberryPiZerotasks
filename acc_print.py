...
3. Compile the C code
    ...
    run the following code:
        gcc -shared -o sample_print_loop_C_code.so -fPIC sample_print_loop_C_code.c -l wiringPi
...
lib = ctypes.CDLL('./acc_sampling.so')
lib.main.argtypes = (ctypes.c_int, ctypes.POINTER(ctypes.c_char_p))
lib.main.restype = ctypes.c_int

args = (ctypes.c_char_p * 3)(b"./program", str(data_log_duration).encode('utf-8'))
argc = len(args)
